    ...
    <div className="flex flex-col bg-[url('/diampeniko.png')] bg-cover bg-fixed bg-center">
      <div className='bg-[url(/bg.avif)] mx-auto mt-20 rounded-lg p-5 lg:p-10 w-full max-w-lg'>
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center text-white text-xl text-center">
          ...
          <div className='text-gray-900 text-sm mt-5'>
            <p>Alohan'ny hisoratana anarana, vakio ireo fitsipika mifehy ny mpikambana <a href="" className='underline text-blue-500'>fitsipika fifampifehezana eto amin'ny tranokala</a></p>
